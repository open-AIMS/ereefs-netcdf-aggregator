 ...
 * {@link Pipeline} to perform {@code ThresholdExceedanceCount} for {@code Speed} inputs.
 *
 * @author Aaron Smith
 */
public class SpeedThresholdExceedanceCountFactoryAdaptor implements ThresholdExceedanceFactoryAdaptor {

    /**
     * Configuration constant identifying the type of {@code SummaryOperator} supported by this
     * factory.
     */
    static public final String VALUE_OPERATOR_TYPE = "THRESHOLD_SPEED_VALUE_EXCEEDANCE_COUNT";
    static public final String ZONAL_OPERATOR_TYPE = "THRESHOLD_SPEED_ZONAL_EXCEEDANCE_COUNT";
    ...
    public Pipeline make(int maxAccumulationTimeSlices,
        ...
        return new BasicPipeline(speedTransformerStage, sumCollectorStage);
    }
