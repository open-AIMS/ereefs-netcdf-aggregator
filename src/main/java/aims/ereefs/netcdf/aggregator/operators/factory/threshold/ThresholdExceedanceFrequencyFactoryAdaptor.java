 ...
 * {@link Pipeline} to perform {@code ThresholdExceedanceFrequency}.
 *
 * @author Aaron Smith
 */
public class ThresholdExceedanceFrequencyFactoryAdaptor implements ThresholdExceedanceFactoryAdaptor {

    /**
     * Configuration constant identifying the type of {@code SummaryOperator} supported by this
     * factory.
     */
    static public final String VALUE_OPERATOR_TYPE = "THRESHOLD_VALUE_EXCEEDANCE_FREQUENCY";
    static public final String ZONAL_OPERATOR_TYPE = "THRESHOLD_ZONAL_EXCEEDANCE_FREQUENCY";
    ...
    public Pipeline make(int maxAccumulationTimeSlices,
        ...
        return new BasicPipeline(meanAccumulatorStage, meanCollectorStage);
    }
