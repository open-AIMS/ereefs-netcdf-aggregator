...
/**
 * Tests for the {@link JustOneFilenameGenerator} class.
 *
 * @author Aaron Smith
 */
public class JustOneFilenameGeneratorTest {

    final int DEFAULT_HOURS_PER_TIME_INCREMENT = 1;

    final static public String PATTERN = "ONE";
    ...
    public void testGenerateForTime() {
        ...
        OutputFileNameGenerator generator = OutputFilenameGeneratorHelper.makeGenerator(
            ...
            PATTERN,
            JustOneFilenameGenerator.class
        );
